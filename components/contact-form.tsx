    ...
    <div className="bg-white p-8 rounded-sm shadow-sm">
      ...
      <form action={formAction}>
        <div className="grid md:grid-cols-2 gap-7 mt-6">
          <div>
            <input
              type="text"
              name="name"
              className="bg-gray-50 border border-gray-200 rounded-sm w-full font-light"
              placeholder="Name*"
            />
        ...
        <button
          type="submit"
          className={clsx(
            "px-10 text-center py-4 mt-5 font-semibold text-white w-full bg-orange-400 rounded-sm hover:bg-orange-500 cursor-pointer",
            {
